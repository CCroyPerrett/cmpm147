...
const fillers = {
  ...
  profession: ["librarian", "fireman", "serial killer", "police officer", "bulter", "priest", "lifeguard", "baseball star", "chef", "maid", "astronaught", "clown", "gambler", "fashion icon", "lucky student", "piano player", "nurse", "animal tamer", "gamer", "anthropologist", "entomologist", "detective", "my mom", "teacher", "merchant", "lawyer"],
  trait: ["shy", "confident", "kind", "manical", "studios", "psycho", "egotistical", "eccentric", "lazy", "mysterious", "cruel", "adventerous", "creative", "optimistic", "depressed", "confident", "flirty", "intelligant", "obnoxious", "sleepy", "scared", "creepy"],
